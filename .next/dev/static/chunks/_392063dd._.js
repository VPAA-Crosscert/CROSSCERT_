...
function SignIn() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SignIn.useEffect": ()=>{
            const initializeCsrf = {
                "SignIn.useEffect.initializeCsrf": async ()=>{
                    try {
            ...
            }["SignIn.useEffect.initializeCsrf"];
            initializeCsrf();
        }
    }["SignIn.useEffect"], []);
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].login(), {
                method: 'POST',
                body: JSON.stringify({
                    email,
                    password
...
_s(SignIn, "hBJaxIpd5t3KnDvKPg173c/oKfU=", false, function() {
    return [
...
//# sourceMappingURL=_392063dd._.js.map